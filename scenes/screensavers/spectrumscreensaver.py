...
ScreensaverScene
"""
class SpectrumScreensaver(PiScene):
	...
	def make_screenaver(self):
		self.ss = Spectrum(ui.Rect(0,0,self.frame.width,self.frame.height))
		self.add_child(self.ss)
	...
	def draw(self, force=False):
		self.ss.draw()
		self.track.draw()
		self.top_screen.blit(self.ss.surface, self.ss.frame.topleft)
