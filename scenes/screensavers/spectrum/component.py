...
class Component(object):
		...
		def __init__(self, screen, c=None, x=0, y=0, bb=None, fgr=(0, 0, 0), bgr=(0, 0, 0), v=True, t=0):
				""" Initializer
				
				:param util: utility object --> screen
				...
				"""
				self.screen = None
				self.screen = screen #util.pygame_screen
				self.content = c
				self.content_x = x
				self.content_y = y
				if bb: 
